...
const APP_DATA = [
  ...
  // LIFE
  {
    ...
    category: "LIFE",
    icon: "🍜",
    desc: "우시 청학골, 경복궁, 홍보각, 란조라면, 지스김밥 맛집 메뉴판 앱",
